...
, beforePan: null
, onPan: null
, onUserPan: null // custom event, return false to cancel
, onUserZoom: null // custom event, return false to cancel
, onDoubleClick: null // custom event
...
SvgPanZoom.prototype.handleMouseWheel = function(evt) {
  ...
  // custom evt
  if (this.options.onUserZoom) {
    if (this.options.onUserZoom(evt) === false) {
      return
    }
  }
...
SvgPanZoom.prototype.getPublicInstance = function() {
  ...
  if (!this.publicInstance) {
    ...
    , getCTM: function() { return that.viewport.getCTM() }
      // CTM update
